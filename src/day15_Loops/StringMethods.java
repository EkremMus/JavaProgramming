...
public class StringMethods {
    public static void main(String[] args) {
        ...
        boolean r1 = str.isBlank(); //if contains spaces it is blank
...
// Yes, YES, yEs, yES, YEs...
        ...
        // in order to ignore the case sensitivity we first create the lower case/upper case version of
        // string and then compare it with lowercase/uppercase
