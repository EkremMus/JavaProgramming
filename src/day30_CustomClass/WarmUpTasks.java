...
public class WarmUpTasks {
    ...
    public static void main(String[] args) {
        ...
        // Collections.swap (numbers, 0, numbers.size() -2);
        ...
        ArrayList<Integer> list = new ArrayList<>(); // 1.st option for solutions
        ...
        ArrayList<Integer> list2 = new ArrayList<>(); // 2.option for solutions
