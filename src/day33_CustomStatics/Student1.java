...
public class Student1 {
    ...
    public Student1(String name, char gender, int age) {
        this (name, gender);
        this.age = age;
    }

    public Student1(String name, char gender, int age, int studentID) {
        this (name, gender, age);
        this.studentID = studentID;
    }

    public Student1(String name, char gender, int age, int studentID, char grade) {
